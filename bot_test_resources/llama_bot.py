...
# This should point to your LLaMA-Factory or Axolotl output folder
ADAPTER_PATH = f"{BASE_PATH}/bot_test_resources/llama/qlora-out/checkpoint-129" 
...
def load_fine_tuned_llm():
    print("--- Loading Fine-Tuned Advisor Brain ---", flush=True)
    ...
    # Attach your specific W&M Advisor personality
