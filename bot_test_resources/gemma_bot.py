...
# Update to point to your new Gemma output directory. 
# (Remember to append the specific /checkpoint-XXXX folder if one was generated)
ADAPTER_PATH = "/sciclone/scr10/gzdata440/wm_bot/bot_test_resources/gemma/qlora-out/checkpoint-69"
...
def load_fine_tuned_llm():
    print("--- Loading Fine-Tuned Advisor Brain ---")
    ...
    # Attach your custom LoRA weights
    model = PeftModel.from_pretrained(base_model, ADAPTER_PATH)
    return model, tk

llm, tokenizer = load_fine_tuned_llm()
